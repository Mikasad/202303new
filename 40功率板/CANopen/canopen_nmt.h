...
enum enum_nodeState {
 ...
 DIS_CONNECTED			=0x0001,
 CONNECTING				  =0x0002,
 PREPARING					=0x0002,
 STOP               =0x0004,
 OPERATION_STATE    =0x0005,
 PRE_OPERATIONG    =0x007F,
 UNKNOWN_STATE			=0x000F
};
...
#define CANID_TPDO1               0x00000180
#define CANID_RPDO1               0x00000200
#define CANID_TPDO2               0x00000280
#define CANID_RPDO2               0x00000300
#define CANID_TPDO3               0x00000380
#define CANID_RPDO3               0x00000400
#define CANID_TPDO4               0x00000480
#define CANID_RPDO4               0x00000500
