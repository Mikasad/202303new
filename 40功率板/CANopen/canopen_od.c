...
//                    unsigned char CANMaster_highestSubIndex_obj1800 = 6; /* number of subindex - 1*/
//                    unsigned int CANMaster_obj1800_COB_ID_used_by_PDO = 0x182;	/* 514 */
//                    unsigned char CANMaster_obj1800_Transmission_Type = 0x0;	/* 1 */
//                    short int CANMaster_obj1800_Inhibit_Time = 0x0;	/* 0 */
//                    unsigned char CANMaster_obj1800_Compatibility_Entry = 0x0;	/* 0 */
//                    short int CANMaster_obj1800_Event_Timer = 1000;	/* 0 */
//                    unsigned char CANMaster_obj1800_SYNC_start_value = 0x0;	/* 0 */
//index_pObjDictry ObjDict_Index1800[]=
//{
//    //TPDO1通信参数
//    {0x1800,0,CONST,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&CANMaster_highestSubIndex_obj1800},//对象条目记录
//    {0x1800,1,RW,UNSIGNED32,SIZE_UINT32,PDO_BAN,(void*)&CANMaster_obj1800_COB_ID_used_by_PDO},//TPDO1 COB-ID
//    {0x1800,2,RW,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&CANMaster_obj1800_Transmission_Type},//传输类型
//    {0x1800,3,RW,UNSIGNED16,SIZE_UINT16,PDO_BAN,(void*)&CANMaster_obj1800_Inhibit_Time},//禁止时间
//    {0x1800,4,RW,UNSIGNED32,SIZE_UINT32,PDO_BAN,(void*)&CANMaster_obj1800_Compatibility_Entry},//Reserved，读取或写入将导致SDO中止应答(参见CANopen301 P131)
//    {0x1800,5,RW,UNSIGNED32,SIZE_UINT16,PDO_BAN,(void*)&CANMaster_obj1800_Event_Timer},//触发事件时间
//    {0x1800,6,RW,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&CANMaster_obj1800_SYNC_start_value},//SYNC起始值，为0表示该PDO不处理SYNC帧的计数，为1-240表示处理SYNC帧的计数，SYNC帧计数器等于该值时，视为收到一帧，当PDO存在时该值不应更改
//};
index_pObjDictry ObjDict_Index1800[]=
{
    //TPDO1通信参数
...
uint8_t ParInNum4 = 4;
uint8_t ParInNum2 = 2;
extern int test_Lack_Count;
extern int Bldc_lack_flag;
index_pObjDictry ObjDict_Index2001[]=
{
    ...
    {0x2001,4,RW,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&MotorControl[8].Motor_Start_Stop},	//电机8对应外接无刷边刷2 J12
    ...
    {0x2001,8,RW,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&MotorControl[9].Motor_Start_Stop},  //电机9对应外接无刷风机 J13
    ...
    {0x2001,15,RW,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&MotorControl[7].Motor_mode}, //边刷与风机控制模式 1:485控制  2：端口控制
    {0x2001,16,RW,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&MotorControl[8].Motor_mode},
    {0x2001,17,RW,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&MotorControl[9].Motor_mode},		
    {0x2001,18,RW,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&P15V_EN}, //无刷电机电源与单向有刷电机电源
    {0x2001,19,RW,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&QV_EN},	 //快开阀 替代喷水电磁阀和电动阀
		{0x2001,20,RO,UNSIGNED32,SIZE_INTEGER32,PDO_ALLOW,(void*)&Motor_livestate}, //14个电机使能状态标志
};
...
index_pObjDictry ObjDict_Index2003[]=
{
    ...
    {0x2003,3,RW,UNSIGNED16,SIZE_UINT16,PDO_ALLOW,(void*)&MotorControl[5].PWM_Duty},
    {0x2003,4,RW,UNSIGNED16,SIZE_UINT16,PDO_ALLOW,(void*)&MotorControl[6].PWM_Duty},
    {0x2003,5,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&BLDC_TYPE},
    {0x2003,6,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&Bldc_lack_flag},
...
uint8_t obj200B_OTA_Default = 0x00;
...
{
    {0x200B,0,RW,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&obj200B_OTA_Default},
};
unsigned char obj2098_NodeID_Default = 0x03;
...
{
    {0x3001,0,RO,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&ParInNum10},
    ...
    {0x3001,4,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&MotorControl[8].PWM_DutySet}, //边刷2
    {0x3001,5,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&MotorControl[9].PWM_DutySet}, //风机J13
    {0x3001,6,RW,UNSIGNED8,SIZE_UINT8,PDO_ALLOW,(void*)&Side_brush_report}, //边刷在位自检设置 0:null 1:开启自检 2：自检完成
    {0x3001,7,RW,UNSIGNED8,SIZE_UINT8,PDO_ALLOW,(void*)&Side_brush_live7}, // 左边刷是否在位：0：null 1：不在位 2：在位
    {0x3001,8,RW,UNSIGNED8,SIZE_UINT8,PDO_ALLOW,(void*)&Side_brush_live8}, //	右边刷是否在位：0：null 1：不在位 2：在位
    {0x3001,9,RW,UNSIGNED8,SIZE_UINT8,PDO_ALLOW,(void*)&Roll6_brush_report}, //滚刷 0:null 1:开启自检 2：自检完成
    {0x3001,10,RW,UNSIGNED8,SIZE_UINT8,PDO_ALLOW,(void*)&Roll_Side_brush_live6}, // 滚刷是否在位：0：null 1：不在位 2：在位
};
index_pObjDictry ObjDict_Index3002[]=
{
    ...
    {0x3002,4,RO,INTEGER32,SIZE_INTEGER32,PDO_ALLOW,(void*)&MotorControl[8].Speed_Real},		//J13//边刷2
    {0x3002,5,RO,INTEGER32,SIZE_INTEGER32,PDO_ALLOW,(void*)&MotorControl[9].Speed_Real},		//风机
};
index_pObjDictry ObjDict_Index3003[]=
{
    {0x3003,0,RO,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&ParInNum10},
    {0x3003,1,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&MotorControl[5].Current.SetValue}, //滚刷自适应电流（A）*38
    {0x3003,2,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&MotorControl[6].Current.SetValue}, //电流（A）*21
...
index_pObjDictry ObjDict_Index3007[]=
{
    ...
    {0x3007,5,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&MotorControl[9].Acceleration},
};
index_pObjDictry ObjDict_Index3008[]=
{
    ...
    {0x3008,5,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&MotorControl[9].Deceleration},
};
extern int CurSelfAdapt_Value;  
extern int CurSelfAdapt_Time;
index_pObjDictry ObjDict_Index3009[]=
{
  {0x3009,0,RO,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&ParInNum4},
  {0x3009,1,RW,INTEGER16,SIZE_INTEGER16,PDO_BAN,(void*)&CurSelfAdapt_Value},
  {0x3009,2,RW,INTEGER16,SIZE_INTEGER16,PDO_BAN,(void*)&CurSelfAdapt_Time},
...
index_pObjDictry ObjDict_Index300A[]=
{
    ...
    {0x300A,5,RW,UNSIGNED8,SIZE_UINT8,PDO_ALLOW,(void*)&MotorControl[9].Fault_Flag},
};
...
index_pObjDictry ObjDict_Index300D[]=
{
    ...
    {0x300D,4,RW,INTEGER32,SIZE_INTEGER32,PDO_ALLOW,(void*)&wGlobal_Flags2},
    {0x300D,5,RW,INTEGER32,SIZE_INTEGER32,PDO_ALLOW,(void*)&FaultOccurred2},
};
...
index_pObjDictry ObjDict_Index3011[]=
{
    ...
    {0x3011,3,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&MotorControl[2].PWM_DutySet},
    ...
    {0x3011,6,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&MotorControl[0].PWM_DutySet},
...
index_pObjDictry ObjDict_Index3017[]=
{
    ...
    {0x3017,1,RW,UNSIGNED8,SIZE_UINT8,PDO_ALLOW,(void*)&MotorControl[0].Push_motor_calibrationFLAG},		//尘推推杆
    {0x3017,2,RW,UNSIGNED8,SIZE_UINT8,PDO_ALLOW,(void*)&MotorControl[1].Push_motor_calibrationFLAG},	  //滚刷推杆 写入1开始标定 读取为2表示标定成功
    {0x3017,3,RW,UNSIGNED8,SIZE_UINT8,PDO_ALLOW,(void*)&MotorControl[2].Push_motor_calibrationFLAG},
    {0x3017,4,RW,UNSIGNED8,SIZE_UINT8,PDO_ALLOW,(void*)NULL},
};
...
PDO_TRANS_Status  pPdoPar = {\
    ...
    {   /* PDO MAP */\
        {   /* TPDO1 MAP 滚刷速度（四字节） 左边刷速度（四字节）*/\
            0x2,       /* 映射参数子索引数Table[8][1] */\
            {   /* show status */\
                {0x30020120},{0x30020320},{NULL},{NULL},{NULL},{NULL},{NULL},{NULL}\
            }\
        },\
        {   /* TTPDO1 MAP 风机速度（四字节） 右边刷速度（四字节）*/\
            0x2,\
            {   /* show status and current mode f operation */\
                {0x30020420},{0x30020520},{NULL},{NULL},{NULL},{NULL},{NULL},{NULL}\
            }\
        },\
        {   /* TPDO2 MAP 滚刷电流（两字节）滚刷推杆位置（两字节） 全部电机使能状态（四字节） */\
            0x3,\
            {   /* show status and current position(pp) */\
                {0x30040310},{0x30110410},{0x20011420},{NULL},{NULL},{NULL},{NULL},{NULL}\
            }\
        },\
        {   /* TPDO4 MAP  主错误码（四字节） 子错误码（四字节）*/\
            0x2,\
