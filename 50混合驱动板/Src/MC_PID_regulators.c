...
//  hSpeed_Reference = PID_SPEED_REFERENCE;
    ...
    PID_Speed->hLower_Limit_Output= -MotorControl[5].Current.MaxValue1;   //Lower Limit for Output limitation
    PID_Speed->hUpper_Limit_Output= MotorControl[5].Current.MaxValue1;   //Upper Limit for Output limitation
    PID_Speed->wLower_Limit_Integral = -MotorControl[5].Current.MaxValue1 * SP_KIDIV;
    PID_Speed->wUpper_Limit_Integral = MotorControl[5].Current.MaxValue1 * SP_KIDIV;
