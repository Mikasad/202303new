...
/*设备制造商区域0x2000 - 0x5FFF BEGIN*/
		...
		index_pObjDictry ObjDict_Index2003[]=
    {
			...
			{0x2003,1,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&MotorControl[5].Pole_Paires},
			{0x2003,2,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&MotorControl[6].Pole_Paires},
			{0x2003,3,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)NULL},
			{0x2003,4,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)NULL},
			{0x2003,5,RO,INTEGER8,SIZE_INTEGER8,PDO_ALLOW,(void*)&Motor_Type},                     //滚刷电机选择，0：联谊滚刷电机   1：合泰盘刷电机
...
//    uint8_t obj200C_OTA_Default = 0x00;
//	ODCallback_t Index200C_callbacks[] =
//	{
//		ODCallback_t_Index200C_Subindex0,
//	};
//	index_pObjDictry ObjDict_Index200C[]=
//	{
//		{0x200C,0,RW,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&obj200C_OTA_Default},
//	};
		unsigned char obj2098_NodeID_Default = 0x01;
    ...
    index_pObjDictry ObjDict_Index2099[]=
    {
      {0x2099,1,RW,UNSIGNED32,SIZE_UINT32,PDO_BAN,(void*)&obj2099_CanBandrate_Default}, 
		    ...
		    index_pObjDictry ObjDict_Index3000[]=
		{
			...
			{0x3000,2,RO,INTEGER32,SIZE_INTEGER32,PDO_ALLOW,(void*)&ProgramVersion.uVersionFullVersion},		//版本号 2022.2.17 add
		...
		index_pObjDictry ObjDict_Index3001[]=
		{
			...
			{0x3001,2,RW,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&MotorControl[6].Speed_PWN_Select},
		...
		index_pObjDictry ObjDict_Index3004[]=
		{
            ...
            {0x3004,4,RO,INTEGER16,SIZE_INTEGER16,PDO_ALLOW,(void*)&BDeepFilter},
		};
		...
		{
			{0x300D,0,RO,INTEGER32,SIZE_INTEGER32,PDO_ALLOW,(void*)&wGlobal_Flags}, //PDO可选
			{0x300D,1,RO,INTEGER32,SIZE_INTEGER32,PDO_ALLOW,(void*)&FaultOccurred},
			{0x300D,2,RO,INTEGER32,SIZE_INTEGER32,PDO_ALLOW,(void*)&wGlobal_Flags1},
			{0x300D,3,RO,INTEGER32,SIZE_INTEGER32,PDO_ALLOW,(void*)&FaultOccurred1},
		};
		...
		{
			{0x3011,0,RO,UNSIGNED8,SIZE_UINT8,PDO_BAN,(void*)&ParInNum8},
			{0x3011,1,RW,UNSIGNED8,SIZE_UINT8,PDO_ALLOW,(void*)&Push_Location_model},
		...
		index_pObjDictry ObjDict_Index3012[]=  														//add by diamond 2021.1125
		{
			...
			{0x3012,2,RW,UNSIGNED32,SIZE_UINT32,PDO_ALLOW,(void*)&OverFlow_Cnt[0]},
			{0x3012,3,RW,UNSIGNED32,SIZE_UINT32,PDO_ALLOW,(void*)&OverFlow_Cnt[1]},
			{0x3012,4,RW,UNSIGNED32,SIZE_UINT32,PDO_ALLOW,(void*)&OverFlow_Cnt[2]},
			{0x3012,5,RW,UNSIGNED32,SIZE_UINT32,PDO_ALLOW,(void*)&OverFlow_Cnt[3]},
			{0x3012,6,RW,UNSIGNED32,SIZE_UINT32,PDO_ALLOW,(void*)&OverFlow_Cnt[4]},			
		};
...
//unsigned int ODCallback_t_Index200C_Subindex0(CO_Data *d, const indextable *index, unsigned char bSubindex)
//{
//  uint8_t ota_remote_upgrade ; 
//  /*获取到下发的数据*/
//  ota_remote_upgrade  = *(unsigned int*)index->pSubindex[bSubindex].lpParam;
...
PDO_TRANS_Status  pPdoPar = {\
  ...
  {/* PDO MAP */\
    {/* TPDO1 MAP */\
      ...
      {/* show status */\
        {0x30070110},{0x30070210},{NULL},{NULL},{NULL},{NULL},{NULL},{NULL}\
      }\
    },\
    {/* TPDO2 MAP */\
      0x4,\
    ...
    {/* TPDO4 MAP */\
      ...
      {/* show status and current Vel(pv) */\
       {0x300D0020},{NULL},{NULL},{NULL},{NULL},{NULL},{NULL},{NULL}\
      }\
    },\
    {/* RPDO1 MAP */\
      0x4,\
      {/* Default:Controlword */\
       {0x30070110},{0x30070210},{0x30070310},{0x30070410},{NULL},{NULL},{NULL},{NULL}\
      }\
    },\
    {/* RPDO2 MAP */\
      0x4,\
