...
//  hSpeed_Reference = PID_SPEED_REFERENCE;
    ...
    PID_Speed->hLower_Limit_Output= -MotorControl[6].Current.MaxValue4;   //Lower Limit for Output limitation
    PID_Speed->hUpper_Limit_Output= MotorControl[6].Current.MaxValue4;   //Upper Limit for Output limitation
    PID_Speed->wLower_Limit_Integral = -MotorControl[6].Current.MaxValue4 * SP_KIDIV;
    PID_Speed->wUpper_Limit_Integral = MotorControl[6].Current.MaxValue4 * SP_KIDIV;
...
s16 PID_Regulator(s16 hReference, s16 hPresentFeedback, PID_Struct_t *PID_Struct)
{
    ...
    if (PID_Struct->OutPreSat >= PID_Struct->hUpper_Limit_Output)  //7980 = 8400*0.95
    {
