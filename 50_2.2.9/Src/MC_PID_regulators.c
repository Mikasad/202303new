...
//  hSpeed_Reference = PID_SPEED_REFERENCE;
    ...
    PID_Speed->hLower_Limit_Output= -MotorControl[5].Current.MaxValue3*2;   //Lower Limit for Output limitation
    PID_Speed->hUpper_Limit_Output= MotorControl[5].Current.MaxValue3*2;   //Upper Limit for Output limitation
    PID_Speed->wLower_Limit_Integral = -MotorControl[5].Current.MaxValue3 * SP_KIDIV;
    PID_Speed->wUpper_Limit_Integral = MotorControl[5].Current.MaxValue3 * SP_KIDIV;
