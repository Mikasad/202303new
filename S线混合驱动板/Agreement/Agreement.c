...
static void changestartstop(void)
{
	if(SendFlag==1)
	{
	transbuf[1]=MotorControl[0].Push_motor_calibrationFLAG;
	transbuf[18]=MotorControl[3].PercentOfPWM;
	transbuf[19]=MotorControl[4].PercentOfPWM;
	transbuf[20]=MotorControl[7].PercentOfPWM;
	transbuf[21]=MotorControl[8].PercentOfPWM;
//	transbuf[23]=MotorControl[10].PercentOfPWM;
//	transbuf[24]=MotorControl[11].PercentOfPWM;
//	transbuf[25]=MotorControl[12].PercentOfPWM;
//	transbuf[26]=MotorControl[13].PercentOfPWM;
	...
	transbuf[47]= MotorControl[5].PWM_Duty;   //电机3电流
	transbuf[48]= MotorControl[5].Speed_Ref;   //电机4电流
	transbuf[49]= MotorControl[5].Speed_Real;   //电机5电流
	transbuf[50]= MotorControl[5].Current.ADCValue_Ref;   //电机6电流
...
//	transbuf[79]=MotorControl[9].Deceleration; //电机9减速度
	transbuf[80]=MotorControl[0].Adjust_Flag; // 校准完成                          电机10减速度
	transbuf[81]=Push_Type; // 推杆类型                                          电机11减速度
	transbuf[82]=Select_Flag; // 校准成功                                  电机12减速度
	transbuf[83]=MotorControl[0].Hall.HALL_CaptureValue_Max; //最大hall记录                           电机13减速度
...
//		MotorControl[13].Motor_Start_Stop=transbuf[14];
		MotorControl[3].PercentOfPWM=transbuf[18];
		MotorControl[4].PercentOfPWM=transbuf[19];
		MotorControl[7].PercentOfPWM=transbuf[20];
		MotorControl[8].PercentOfPWM=transbuf[21];
//		MotorControl[10].PercentOfPWM=transbuf[23];
//		MotorControl[11].PercentOfPWM=transbuf[24];
//		MotorControl[12].PercentOfPWM=transbuf[25];
//		MotorControl[13].PercentOfPWM=transbuf[26];
...
{   \
   {0,1000,WR,NOFLASH,(long*)&transbuf[0]},
	{1,1000,WR,NOFLASH,(long*)&transbuf[1]},  //电机0使能
