...
#define PHASE_ERR_MAX          	5000
#define SUTCK_ERR_MAX         	1000
#define PWMMAX	499
#define PWMMin        0
...
#define MOTOR0_CurrentValue(A)   (A*1230)  //A  电流检测范围为 21.15A 4mo
#define MOTOR1_CurrentValue(A)   (A*1230) 	//A  电流检测范围为 21.15A 4mo
#define MOTOR2_CurrentValue(A)   (A*194) 	//A  电流检测范围为 21.15A 4mo
#define MOTOR3_CurrentValue(A)   (A*1230)  //A  电流检测范围为28.2A 3mo
#define MOTOR4_CurrentValue(A)   (A*1230) 	//A  电流检测范围为28.2A 3mo
#define MOTOR5_CurrentValue(A)   (A*121)	  //A  电流检测范围为35.25A 2mo
#define MOTOR6_CurrentValue(A)   (A*121)	  //A  电流检测范围为35.25A 2mo
#define MOTOR7_CurrentValue(A)   (A*1230)
#define MOTOR8_CurrentValue(A)   (A*121)
...
#define BIT6 0x40
#define BIT7 0x80
#define NEED_TO_CURRPROJECT_MOTORNUM  9   //需要过流保护电机个数
...
#define  FAN_SHORT_CIRCUIT	             0X00000004
#define  ONEWYA_MOTOR1_OVER_CUR          0X00000008    //水泵过流

#define  ONEWYA_MOTOR2_OVER_CUR          0X00000010
#define  BLDC1_OVER_CUR           		 0X00000020
#define  SIDE_BRUSH_OVER_CUR             0X00000040    //边刷过流
#define  OVER_VOLTAGE                    0X00000080

#define  UNDER_VOLTAGE                   0X00000100
#define  PUSH_SELF_CHK_ERR         		 0X00000200     //滚刷自适应调节失败
#define  HALL5_SENSOR_ERR         		 0X00000400
#define  PUSH1_HIGHT_ERR          		 0X00000800//   
...
#define  PUSHMOTOR_INT_ERROR			 0X00020000//
...
#define  MOTOR5_MISSING_PHASE            0X00200000 //电机5启动时就缺相，无法检测是哪一相
#define  MOTOR5_AUTOCHECK_ERR            0X00400000    //电机5自检失败
#define  PUSH_BRAKE_LINE    			 0X00800000

#define  PUSH_LOST_HALL    				 0X01000000
#define  PUMP_OVER_TEMP		             0X02000000      //水泵过温
#define  MOTOR3_BRAKE_LINE    			 0X04000000
#define  MOTOR4_BRAKE_LINE    			 0X08000000
...
#define   PUSH0_CALIBRATE              0X00400000	//推杆0标定超时
#define   PUSH1_CALIBRATE              0X00800000	//推杆1标定超时
#define   PUSH2_CALIBRATE              0X01000000	//推杆2标定超时
#define   PUSH9_CALIBRATE              0X02000000	//推杆9标定超时
...
#define VOLT_160V (945)
#define VOLT_200V (1181)  //欠压恢复点
//#define VOLT_240V (1519)
//#define VOLT_330V (2066)
#define VOLT_300V (1830)  //过压恢复点
#define VOLT_360V (2184)
...
#define RED_LED_ON     			HAL_GPIO_WritePin(GPIOA,GPIO_PIN_15,GPIO_PIN_SET)
#define RED_LED_OFF 				HAL_GPIO_WritePin(GPIOA,GPIO_PIN_15,GPIO_PIN_RESET)
#define RED_LED_TOGGLE			HAL_GPIO_TogglePin(GPIOA,GPIO_PIN_15)
#endif
...
extern uint32_t ADC_ConvertedValue[15];
extern u16 BLDC_SPEED_COEEFFOCIENT;
/*
***********************************************
* User Functions
***********************************************
...
void Bldc_Hall_Check(void) ;
void  Motor3_Temperation_Protect(void);
void Adaptive_Rolling_Brush_Detection(void);
void Motor5_Auto_Check(void);
#endif
