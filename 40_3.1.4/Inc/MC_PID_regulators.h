...
#define MOTOR_NUM 14
#define NOMINAL_CURRENT  8400  //PWM Max
...
#define PID_SPEED_KP_DEFAULT      (s16)700  //原来是500,256，100
#define PID_SPEED_KI_DEFAULT      (s16)2   //原来是10
...
#define KP_GAIN_CURRENT_MIN  (s16)(800)       //电流环kp
