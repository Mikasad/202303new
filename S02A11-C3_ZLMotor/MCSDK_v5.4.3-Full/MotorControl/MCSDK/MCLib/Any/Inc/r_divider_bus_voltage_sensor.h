...
uint32_t RVBS_CalcAvVbusFilt( RDivider_Handle_t * pHandle );
uint32_t RVBS_CalcAvVbus( RDivider_Handle_t * pHandle );
uint32_t RVBS_CheckFaultState( RDivider_Handle_t * pHandle );
