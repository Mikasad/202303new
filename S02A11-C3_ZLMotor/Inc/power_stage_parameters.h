...
#define VBUS_PARTITIONING_FACTOR      0.058  //理论值 0.05993  实际值 0.058
                                                     /*!< It expresses how 0.0463
...
/*********** Bus voltage sensing section ****************/
#define VBUS_PARTITIONING_FACTOR2      0.0463 /*!< It expresses how 
                                                       much the Vbus is attenuated  
                                                       before being converted into 
                                                       digital value */
...
#define RSHUNT2                        0.0030 

/*  ICSs gains in case of isolated current sensors,
        amplification gain for shunts based sensing */
#define AMPLIFICATION_GAIN2            20.00 

/*** Noise parameters ***/
#define TNOISE_NS2                     500
#define TRISE_NS2                      500 
